...
Image<float> gradient_tester(Image<uint8_t> in) {
    Image<float> out(in.width(), in.height(), in.channels()); //TODO: make this a float. 
...
int main(int argc, char **argv) {
    ...
    Image<float> gradient_result = gradient_tester(input);
