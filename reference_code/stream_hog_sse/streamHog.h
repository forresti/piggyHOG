...
class streamHog{
  ...
  public:
    ...
    void computeCells_stream_output_16bit(int imgHeight, int imgWidth, int imgStride, int sbin,
                                    uint8_t *__restrict__ ori, int16_t *__restrict__ mag,
                                    int outHistHeight, int outHistWidth,
                                    int16_t *__restrict__ outHist);

    void computeCells_stream_noBoundsCheck(int imgHeight, int imgWidth, int imgStride, int sbin,
                                    uint8_t *__restrict__ ori, int16_t *__restrict__ mag,
                                    int outHistHeight, int outHistWidth,
                                    float *__restrict__ outHist);
    ...
    void normalizeCells_voc5(float *__restrict__ in_hogHist, float *__restrict__ in_normImg,
